...
@interface TrainStyleViewController ()
...
{
    [super viewDidLoad];
    styleName = [[NSArray alloc]initWithObjects:@"對號車種",@"非對號車種",@"所有車種", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [styleName objectAtIndex:indexPath.row];
