...
-(void)UpdataColorFromFirstTap:(NSNumber *)firstTap ColorCourseName:(NSString*)Name
{
    NSRange range =  NSMakeRange([firstTap intValue]%10000/100,[firstTap intValue]%100);
...
{
    //for (int i = 0 ; i<50 ; ++i){
    NSDictionary* info = [Moodle_API Login:@"09957037" andPassword:@"L124631945"];
