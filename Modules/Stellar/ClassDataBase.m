...
-(id)init
{
    ...
    if (self) {
        ...
        if ([userPrefs objectForKey:ClassDataBaseKey]==nil) {
            ...
            ColorTempDic = [[NSMutableDictionary alloc]init];
            
            professorName = [[NSMutableDictionary alloc]init];
            classroomLocation = [[NSMutableDictionary alloc]init];
            professorTempName = [[NSMutableDictionary dictionaryWithDictionary:professorName] retain];
            classroomTempLocation = [[NSMutableDictionary alloc]init];
            moodleTempFrom = [[NSMutableDictionary alloc]init];
            courseTempCount = [[NSMutableDictionary alloc]init];
            courseID = [[NSMutableDictionary alloc]init];
            courseTempID = [[NSMutableDictionary alloc]init];
            classID = [[NSMutableDictionary alloc]init];
            classTempID = [[NSMutableDictionary alloc]init];
        }
        else
        {
            NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
